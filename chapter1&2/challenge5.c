...
int main(void)
{
    ...
    // calculation
    float monthlyRate = interest/1200;
    float remaining1 = amount - payment + (amount*monthlyRate);
    printf("Balance remaining after first payment: %.2f \n",remaining1);

    float remaining2 = remaining1 - payment + (remaining1*monthlyRate);
    printf("Balance remaining after first payment: %.2f \n",remaining2);

    float remaining3 = remaining2 - payment + (remaining2*monthlyRate);
    printf("Balance remaining after first payment: %.2f\n",remaining3);
